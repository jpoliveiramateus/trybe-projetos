...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(typeof Object.values(createMenu())[0]).toBe('function');
    ...
    // ```
    objetoRetornado.order('torta', objetoRetornado);
    objetoRetornado.order('pizza', objetoRetornado);
    expect(objetoRetornado.consumption).toEqual(['coxinha','torta','pizza']);
    ...
    // ```
    objetoRetornado.order('pizza', objetoRetornado);
    expect(objetoRetornado.consumption).toEqual(['coxinha','torta','pizza','pizza']);
    ...
    // ```
    const objetoRetornado2 = createMenu({ food: { coxinha: 3.9, pizza: 30 }, drink: { agua: 3.9 } });
    objetoRetornado2.order('coxinha', objetoRetornado2);
    objetoRetornado2.order('pizza', objetoRetornado2);
    expect(objetoRetornado.pay(objetoRetornado2)).toBe(33.9);
